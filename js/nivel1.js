...
//let edadUsuario = prompt('Por favor, ingresa tu edad', '25');
...
//Preguntar las variables al usuario y guardarlas
//Impriman el resultado en la consola


// function calcularEdadUusario(anioActual, anioNacimiento){
//     return anioActual - anioNacimiento;
// }
// let edad = calcularEdadUusario(prompt('En qué año estamos'), prompt('En qué año naciste'));
...
// let salarioTotalMensual = Number(calcularSalarioMensual(prompt('¿Cuál es tu salario Anual?')))
// console.log(salarioTotalMensual)
...
// let salarioTotalAnual = Number(calcularSalarioAnual(prompt('¿Cuál es tu salario Mensual?')))
// console.log(salarioTotalAnual)


// //Preguntar el salario semanal y calcular el salario diario
// function calcularSalarioDiario(salarioSemanal, diasLaborales){
//     return salarioSemanal / diasLaborales;
// }

// let salarioTotalDiario = Number(calcularSalarioDiario(prompt('¿Cuál es tu salario semanal?'), prompt('¿Cuantos días trabajas semanalmente?')))
// console.log(salarioTotalDiario)


// //Preguntar el salario diario y calcular el salario semanal
// function calcularSalarioSemanal(salarioDiario, diasLaborales){
//     return salarioDiario * diasLaborales;
// }

// let salarioTotalSemanal = Number(calcularSalarioSemanal(prompt('¿Cuál es tu salario diario?'), prompt('¿Cuantos días trabajas semanalmente?')))
// console.log(salarioTotalSemanal)
...
// let operador = prompt('Elige una operación: Sumar = +, Restar = -, Multiplicar = *, Dividir = /');
// if (operador == '+') {
//     console.log(sumar(Number(prompt('Digite el primer número')),Number(prompt('Digite el segundo número'))));
// } else{
//     console.log(restar(Number(prompt('Digite el primer número')),Number(prompt('Digite el segundo número'))));
// }
...
//     console.log(restar(Number(prompt('Digite el primer número')),Number(prompt('Digite el segundo número'))));
// } else if (operador == '*') {
//     console.log(multiplicar(Number(prompt('Digite el primer número')),Number(prompt('Digite el segundo número'))));
// } else if (operador == '/'){
//     console.log(dividir(Number(prompt('Digite el primer número')),Number(prompt('Digite el segundo número'))));
// } else {
