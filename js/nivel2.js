...
// let comidasFavoritas = ['Pizza', 'Hamburguesa', 'Carne', 'Pollo'];
...
//     let cantidadDeNumeros = Number(prompt('¿Cuantos números va a promediar?'));
//     let arrayDeNumeros = [];

    
//     for (let i = 1; i <= cantidadDeNumeros ; i++){
//         let ingresarNumerosArray = Number(prompt(`Ingrese el número ${i}`));
//         arrayDeNumeros.push(ingresarNumerosArray);
//     }
...
//     }
//     return 'El promedio es ' + totalPromedio / arrayDeNumeros.length;
// }

// console.log(calcularPromedio());


// Operador por default o ya predefinido
// Es un operador que ya tiene un valor definido y no hay que otorgarselo a través del llamado de la función 
//o del mismo.
...
// Operador ternario
// Es simplemente una forma diferente de hacer un if/else
//Se usa para operaciones pequeñas

// function verificarEdadEntrada(edad = 18){

//     edad >= 18 ? console.log('Bienvenido al bar') : console.log('Eres menor de edad');
// }
// verificarEdadEntrada(17);


// Diferencia entre ++varaible o variable++

// function testClase5(){
//     let x = 0;
//     let y= ++x;  //Primero se le suma a y y después se le asigna x
//     let z = x++;  //Primero se le asigna x y después se le suma el valor
// }
// testClase5();


// Función anonima
//Una función que es asignada a una variable
